...
{% updates format="full" %}
{% update date="2026-03-28" tags="alpha,pre" %}
...
> 注意：> \
> <i class="fa-1">:1:</i> 插件本次更新会自动兼容旧版本配置文件并备份升级至最新配置文件管理系统，可能需要比以往启动更长的时间> \
> <i class="fa-2">:2:</i> 1.20.X版本现在已经支持，但藏身处地图文件可能有部分新版本方块无法正常显示
{% endupdate %}
